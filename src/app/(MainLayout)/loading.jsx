export default function LoadingPage() {
  return (
    <div className="relative min-h-screen bg-[#0d0d1a] flex flex-col items-center justify-center overflow-hidden">
      {/* Grid background */}
      <div
      ...
      <div className="relative z-10 flex flex-col items-center gap-8">
        ...
        <div className="relative w-16 h-16">
          ...
          {/* Mid ring */}
          <div
            className="absolute inset-2 rounded-full border-[2.5px] border-transparent"
            style={{
          ...
          {/* Inner ring */}
          <div
            className="absolute inset-4.5 rounded-full border-[2.5px] border-transparent animate-spin"
            style={{
